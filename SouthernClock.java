...
public class SouthernClock extends Application {
		
		Image image = new Image("https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Pi-symbol.svg/2000px-Pi-symbol.svg.png");
		...
		Text t = new Text(50, 575, "Created by Will Leach");
		Text t2 = new Text(200, 400, "Prob & Stats");
...
public static void main(String args[]) {
	...
	for (int i = 0; i < 60; i++) {
		...
		t.setStroke(Color.LIGHTGREEN);
		t2.setFont(new Font(35));
		t2.setFill(Color.GREEN);
		t2.setStroke(Color.BLACK);
		
		root.getChildren().addAll(clock, inner, t, t2, iv1, small, hourline, 
